...
<head>
    ...
    <link rel="stylesheet" href="/SafeRideStore/public/styles/adminStyle.css?version=1">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                        <li class="nav-item active">
                            <a class="nav-link" href="/SafeRideStore">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
