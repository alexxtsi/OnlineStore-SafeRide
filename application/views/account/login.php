...
if (isset($_POST['login']) && !empty($_POST['userName']) && !empty($_POST['password'])) {
    ...
    //if customer verified empty string returnd
    if (empty($msg = $controller->customerVerify($_POST['userName']))) {
        //get products from cart to ssesion
        $controller->loadCustomerCart($_POST['userName']);
      
        $_SESSION['fullName'] = $controller->getFullName($_POST['userName']);
